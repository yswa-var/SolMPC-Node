...
func (t *Transport) GetFileName() string {
	return "/Users/apple/Desktop/Tilt-Validator/internal/Transport/" + strconv.Itoa(t.partyID) + ".csv"
}

func (t *Transport) GetReceiverFileName(id string) string {
	return "/Users/apple/Desktop/Tilt-Validator/internal/Transport/" + id + ".csv"
}
